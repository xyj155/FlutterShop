  ...
  Widget build(BuildContext context) {
    ...
    return new Container(
      padding: EdgeInsets.only(
          top: _screenUtils.setWidgetHeight(50),
        ...
        children: <Widget>[
          new Column(
            ...
            children: <Widget>[
              ...
              new Container(
                margin: EdgeInsets.only(
                    bottom: _screenUtils.setWidgetHeight(45),
                    left: _screenUtils.setWidgetWidth(10)),
                child: new Text(
                  "输入4位邀请码激活 就酱 体验资格",
                  style: new TextStyle(
          ...
          new Positioned(
            ...
            bottom: _screenUtils.setWidgetHeight(30),
            left: 0,
            right: 0,
          ),
        ],
...
class UserTelVerifyPage extends StatefulWidget {
  /// 倒计时的秒数，默认60秒。
  final int countdown;
  ...
  @override
  _UserTelVerifyPageState createState() => _UserTelVerifyPageState();
}

class _UserTelVerifyPageState extends State<UserTelVerifyPage>
